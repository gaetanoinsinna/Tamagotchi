...
/*rectangle*/
void LCD_DrawRectangle(uint16_t Xpos,uint16_t Ypos,uint16_t lenght, uint16_t height,uint16_t color,uint16_t bkColor){
	
	int i = 0;
	
	LCD_DrawLine(Xpos,Ypos,Xpos+lenght,Ypos,color);
	LCD_DrawLine(Xpos,Ypos,Xpos,Ypos+height,color);
	
	LCD_DrawLine(Xpos,Ypos+height,Xpos+lenght,Ypos+height,color);
	LCD_DrawLine(Xpos+lenght,Ypos,Xpos+lenght,Ypos+height,color);
	
	for(i = 1;i<height;i++)
		LCD_DrawLine(Xpos+1,Ypos+i,Xpos+lenght-1,Ypos+i,bkColor);
